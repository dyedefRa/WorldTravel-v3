...
* [#12354](http://dev.ckeditor.com/ticket/12354): Fixed: Various issues in undo Service when holding keys.
...
* [#12332](http://dev.ckeditor.com/ticket/12332): Fixed: Lowered DOM events listeners' priorities in undo Service in order to avoid ambiguity.
...
* [#111739](http://dev.ckeditor.com/ticket/11739): Fixed: `keypress` listeners should not be used in the undo Service. A complete rewrite of keyboard handling in the undo Service was made. Numerous smaller issues were fixed, among others:
  ...
  * [#12219](http://dev.ckeditor.com/ticket/12219): [Safari] Fixed: Some modifications of the [`UndoService.locked`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.undo.UndoService-property-locked) property violate strict mode in the [Undo](http://ckeditor.com/addon/undo) plugin.
...
* [#10913](http://dev.ckeditor.com/ticket/10913): Fixed [`CKEDITOR.plugins.addExternal()`](http://docs.ckeditor.com/#!/api/CKEDITOR.resourceService-method-addExternal) not handling paths including file name specified.
...
* [#10315](http://dev.ckeditor.com/ticket/10315): [WebKit] [Undo Service](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.undo.UndoService) should not record snapshots after a filling character was added/removed.
...
* [#10131](http://dev.ckeditor.com/ticket/10131): Fixed: [`undoService.update()`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.undo.UndoService-method-update) does not refresh the command state.
