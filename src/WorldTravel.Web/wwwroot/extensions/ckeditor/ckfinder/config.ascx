...
<%@ Import Namespace="Otokoc.Core.Modules" %>
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        BaseUrl = ConfigSettings.WebSiteUrl + "/media/EditorFiles/";
        //	BaseUrl = "/ckfinder/userfiles/";

        // The phisical directory in the server where the file will end up. If
        // blank, CKFinder attempts to resolve BaseUrl.
        //BaseDir = "";
        BaseDir = ConfigSettings.CkEditorImagesRoot;
        ...
        PluginSettings = new Hashtable { { "ImageResize_smallThumb", "90x90" }, { "ImageResize_mediumThumb", "120x120" }, { "ImageResize_largeThumb", "180x180" }, { "Watermark_source", "logo.gif" }, { "Watermark_marginRight", "5" }, { "Watermark_marginBottom", "5" }, { "Watermark_quality", "90" }, { "Watermark_transparency", "80" } };
