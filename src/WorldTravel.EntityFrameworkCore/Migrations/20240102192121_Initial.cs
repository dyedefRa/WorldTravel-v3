        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileIsOk = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccommodationFee = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBecomeConsultDesc = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Profession = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    IsNeedConsult = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    EducationStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CompanyName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CompanyContact = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PositionName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SpecialRequest = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    JobTip = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RequiredQualification = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SalaryRange = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    HoursWork = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    FormRegType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    FormIsOk = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppForms_AbpUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReceiptOk = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppReceipts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppReceipt_AppFiles",
                        column: x => x.FileId,
                        principalTable: "AppFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppReceipt_Users",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileId = table.Column<int>(type: "int", nullable: false),
                    IsShareContent = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppCountryContent_UserId",
                table: "AppForms",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppReceipt_FileId",
                table: "AppReceipts",
                column: "FileId");

            migrationBuilder.CreateIndex(
                name: "IX_AppReceipt_UserId",
                table: "AppReceipts",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppSlider_FileId",
                table: "AppSliders",
                column: "ImageId");
